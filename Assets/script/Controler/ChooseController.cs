...
public class ChooseController : MonoBehaviour
{
    ...
    public void SetupChoose(ChooseScene scene)
    {
        ...
        for (int index = 0; index < scene.labels.Count; index++)
        {
            ...
            newLabel.Setup(scene.labels[index], this, CalculationLabelPosition(index, scene.labels.Count));
        }
    ...
    private float CalculationLabelPosition(int labelIndex, int labelCount)
    {
        if (labelCount % 2 == 0)
        {
